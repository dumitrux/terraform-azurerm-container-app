...
output "container_app_environment_name" {
  description = "The name of the Container App Environment within which this Container App should exist."
...
output "container_app_name" {
  description = "The names of the Container App."
  value       = values(azurerm_container_app.container_app)[*].name
}
